...
train_df = pd.DataFrame(output_array, columns=("Identifier", "Start", "Stop", "Phrase", "Annotation_Type", "A1c_Value", "A1c_Flag", "Node_ID", "Modifying_Category", "Modified_By", "Node_Modified"))
train_df.head()
...
modifier_columns = train_df[train_df["Node_Modified"]!="None"]
A1c_Value_Results = train_df[["Identifier", "Start", "Stop", "Phrase", "Annotation_Type", "A1c_Value", "A1c_Flag"]].drop(modifier_columns.index, axis = 0)
...
A1c_Value_Results.to_csv("Output_Files/A1c_Results_Training_Dataset.csv")
modifier_columns.to_csv("Output_Files/Modifier_Columns_to_A1c_Training_Dataset.csv") # I know this isn't needed, but I am going to save it for just in case
...
# Manual_Results = pd.read_csv("Manual_Annotation_Results/Manual.Annotation.Train_Dataset.A1c.Results.csv", index_col = 1)
...
# Merged_Manual_and_Machine.to_csv("Output_Files/Training_Dataset_A1c_Result_Comparison.csv")
